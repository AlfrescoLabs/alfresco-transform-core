...
@GrpcService
public class AIOGrpcServiceImpl extends AbstractTransformGrpcService
{
    private static final Logger logger = LoggerFactory.getLogger(AIOGrpcServiceImpl.class);
    ...
    {
        return "All in One Transformer-2";
    }
    ...
    public void transform(org.alfresco.transformer.grpc.TransformRequest request,
        ...
        super.transform(request, responseObserver, transformRegistry);
